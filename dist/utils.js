...
var generateToken = function (user) {
    var _a;
    return jsonwebtoken_1.default.sign(__assign({}, user), (_a = process.env.JWT_SECRET) !== null && _a !== void 0 ? _a : '', {
        expiresIn: '1d',
    });
};
...
var isAuth = function (req, res, next) {
    ...
    if (token) {
        var onlyToken = token.slice(7);
        jsonwebtoken_1.default.verify(onlyToken, (_a = process.env.JWT_SECRET) !== null && _a !== void 0 ? _a : '', function (err, decoded) {
            if (err) {
...
var generateUniqueDataToken = function () {
    return (0, uuid_1.v4)();
};
