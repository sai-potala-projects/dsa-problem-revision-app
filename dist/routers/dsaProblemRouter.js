  ...
  (0, express_async_handler_1.default)(function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
      var userObjectId,
        ...
        modifiedProblems,
        savedProblemsData,
        toBeEditedProblemsData,
        savedProblems,
        newProblemIds,
        userProblems,
        firstTimeUserProblemList,
        response,
        allProblems;
      var _a;
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            savedProblemsData = problems.filter(function (problem) {
              return !problem._id;
            });
            toBeEditedProblemsData = problems.filter(function (problem) {
              return problem._id;
            });
            return [4 /*yield*/, ProblemListModel_1.Problem.insertMany(savedProblemsData)];
          case 1:
            savedProblems = _b.sent();
            newProblemIds = savedProblems.map(function (savedProblem) {
          ...
          case 2:
            ...
            userProblems === null || userProblems === void 0
              ? void 0
              : (_a = userProblems.problems).push.apply(_a, newProblemIds);
            return [4 /*yield*/, userProblems.save()];
          case 3:
            _b.sent();
            return [3 /*break*/, 6];
          case 4:
            firstTimeUserProblemList = new ProblemListModel_1.UserProblemList({
              user: userObjectId,
              problems: __spreadArray([], newProblemIds, true),
            });
          ...
          case 6:
            return [
              4 /*yield*/,
              (0, utils_1.editProblemsUtil)({ userId: userObjectId, updateRecords: toBeEditedProblemsData }),
            ];
          case 7:
            response = _b.sent() || '';
            if (response.error) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              ProblemListModel_1.UserProblemList.findOne({
                user: userObjectId,
          ...
          case 2:
            ...
            if (!isUserRecordFound) {
              res
                .status(401)
                .send({ error: "Cannot edit problem '".concat(record.title, "' as it doesn't exist for the user.") });
              return [2 /*return*/];
            }
            _a.label = 3;
          case 3:
            ...
            return [3 /*break*/, 1];
          case 4:
            updatePromises = updateRecords.map(function (record) {
              return __awaiter(void 0, void 0, void 0, function () {
                var filter;
                return __generator(this, function (_a) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              ProblemListModel_1.UserProblemList.updateMany({}, { $pull: { problems: { $in: problemIds } } }),
            ];
          case 2:
            // Delete problems from UserProblemList collection
            _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            finalProblemList = userProblemList.filter(function (problem) {
            ...
            unsolvedProblems = finalProblemList.filter(function (problem) {
            ...
            if (unsolvedProblems.length > 0) {
              ...
              if (difficultyLevel && difficultyLevel !== '') {
                ...
                filteredProblems = unsolvedProblems.filter(function (problem) {
                  return problem.difficultyLevel === difficultyLevel;
                });
              } else {
                difficultyLevels = ['Easy', 'Medium', 'Hard'];
                selectedDifficultyLevel_1 = difficultyLevels[Math.floor(Math.random() * difficultyLevels.length)];
                filteredProblems = unsolvedProblems.filter(function (problem) {
                  return problem.difficultyLevel === selectedDifficultyLevel_1;
                });
              }
